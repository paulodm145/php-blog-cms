<?php require dirname(__DIR__) . '/partials/site-top.php'; ?>
    <main class="container-lg py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <div class="accent mb-2" style="font-size:.7rem;letter-spacing:.12em;text-transform:uppercase;font-weight:600"><?= htmlspecialchars($kicker, ENT_QUOTES, 'UTF-8') ?></div>
                <h1 class="mb-4" style="font-size:1.9rem;font-weight:700"><?= htmlspecialchars($heading, ENT_QUOTES, 'UTF-8') ?></h1>

                <?php if (count($posts) === 0): ?>
                    <p class="text-muted">Nenhum artigo por aqui ainda.</p>
                <?php else: ?>
                    <div class="row g-4">
