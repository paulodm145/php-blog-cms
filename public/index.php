...
$router->get('/admin/galerias', [AdminGalleryController::class, 'index']);
$router->get('/admin/galerias/create', [AdminGalleryController::class, 'create']);
$router->post('/admin/galerias', [AdminGalleryController::class, 'store']);
$router->get('/admin/galerias/picker', [AdminGalleryController::class, 'picker']);
$router->get('/admin/galerias/{id}/edit', [AdminGalleryController::class, 'edit']);
$router->post('/admin/galerias/{id}/edit', [AdminGalleryController::class, 'update']);
$router->post('/admin/galerias/{id}/delete', [AdminGalleryController::class, 'delete']);
