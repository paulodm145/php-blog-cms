...
// projetos). Cada grade tem um data-gallery diferente (o slug, ou
// "project-{id}" pra galeria de projeto); ao clicar numa miniatura, o
// grupo de navegacao (anterior/proximo/contador) e recalculado na hora
// filtrando so as miniaturas com o MESMO data-gallery — miniaturas de
// grupos diferentes na mesma pagina nunca se misturam.
(function () {
    ...
    function show(index) {
        ...
        image.src = currentGroup[currentIndex];
